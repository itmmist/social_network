  ...
  return (
    <div className='wrapper'>
      ...
      <div className='wrapperContent'>
        <Route exact path='/' render={() => <Profile profile_page={props.state.profile_page} add_post={props.add_post} newPostText={props.state.profile_page.newPostText}/>}/>
        <Route exact path='/profile' render={() => <Profile profile_page={props.state.profile_page} add_post={props.add_post} newPostText={props.state.profile_page.newPostText}/>}/>
        <Route exact path='/messages' render={() => <Messages dialogNames={props.state.dialogs_page.dialogNames} dialogMessages={props.state.dialogs_page.dialogMessages} send_message={props.send_message} />}/>
      </div>
