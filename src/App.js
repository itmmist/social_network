  ...
  return (
    <div className='wrapper'>
      ...
      <div className='wrapperContent'>
        <Route exact path='/' render={() => <Profile profile_page={props.state.profile_page} add_post={props.add_post} />}/>
        <Route exact path='/profile' render={() => <Profile profile_page={props.state.profile_page} add_post={props.add_post} />}/>
